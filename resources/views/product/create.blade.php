...
@section('content')
    ...
    <div x-data="{ type:'', subtype:'', firstStep: $persist(true), secondStep: $persist(false), thirdStep : $persist(false)}">
      ...
      <div x-show="secondStep" x-transition.duration.500ms>
          ...
          <div class="grid lg:grid-cols-3  grid-cols-1 place-items-center items-center gap-2 content-center">
            
            <template x-for="product in typeProducts">
                <div class="w-96 p-6 cursor-pointer bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transition ease-in-out hover:-translate-y-1 hover:scale-110" @click="subtype = product.title ;secondStep = false; thirdStep = true;">
                    <img src="" alt="">
                    <a href="#">
      ...
      <div x-show="thirdStep" x-transition>
