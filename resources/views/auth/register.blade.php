    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
            <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl">Cadastro</h2>
                <p class="mt-2 text-base text-gray-600">Já possui uma conta? <a href="{{ route('login.index') }}" title="" class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Login</a></p>
                ...
                @endsession
                <form action="{{ route('register.save') }}" method="POST" class="mt-8">
                    @csrf
                    <div class="space-y-5">
                        <div>
                            <label for="" class="text-base font-medium text-gray-900"> Usuário </label>
                        ...
                        <div>
                            <label for="" class="text-base font-medium text-gray-900">Confirmação de Senha </label>
                            <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path
                            ...
                            @error('password')
                                <p class="text-red-600 pt-2">{{ str_replace("Senha","Confirmação de Senha",$message) }}</p>
                            @enderror
                        </div>
