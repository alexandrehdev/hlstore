        ...
        <section class="h-full overflow-auto p-8 w-full flex flex-col">
          <header class="py-12 flex flex-col justify-center items-center">
            ...
            <input id="hidden-input" type="file" multiple class="hidden" />
                <button id="button" class="mt-2 h-12 w-1/3 rounded-full text-white font-medium px-3 py-1 bg-black hover:bg-gray-900 focus:shadow-outline focus:outline-none">
                    Escolher
                </button>
          </header>
