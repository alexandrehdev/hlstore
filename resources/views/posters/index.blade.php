...
<section class="container px-4 mx-auto">
    <div class="flex items-center gap-x-3">
        <h2 class="text-lg font-medium text-gray-800 dark:text-white">Posters</h2>

        <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">Você tem 2 Poster(s)</span>
    </div>
   
    <div class="flex justify-end">
        <div class="h-full mt-5 flex flex-col"> 
            <a href="{{ route('posters.create') }}" class="rounded-md bg-blue-500 px-5 py-3 text-base mb-3 font-medium text-white transition duration-200 hover:bg-blue-600 active:bg-blue-700">
                Criar Poster
            </a>             
        </div>
    </div>
